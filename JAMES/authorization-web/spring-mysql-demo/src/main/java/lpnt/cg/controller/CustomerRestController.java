...
//    }
//
//    @RequestMapping(value = "/list-customers/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
...
//    }
//
//    @RequestMapping(value = "/list-customers/{id}", method = RequestMethod.PUT)
...
//    }
//
//    @RequestMapping(value = "/list-customers/{id}", method = RequestMethod.DELETE)
